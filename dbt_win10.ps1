...
#    irm https://[your-raw-gist-url] | iex
#
...
$host.UI.RawUI.WindowTitle = "Windows 10 Debloat Tool"
...
function Show-Menu {
    ...
    Write-Host "  #                                          #" -ForegroundColor Cyan
    Write-Host "  #       WINDOWS 10 DEBLOAT TOOL           #" -ForegroundColor Cyan
    Write-Host "  #                                          #" -ForegroundColor Cyan
    Write-Host "  ############################################" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host "       Removes all bloatware, OneDrive, Cortana," -ForegroundColor DarkGray
    Write-Host "       Teams + disables all trackers/telemetry" -ForegroundColor DarkGray
    Write-Host ""
...
function Invoke-Debloat {
    ...
    $appsToRemove = @(
        ...
        "Microsoft.Xbox.TCUI",
        # Teams (consumer / Chat from Teams on taskbar — Win10 21H2+)
        "MicrosoftTeams",
        "MSTeams",
        "Microsoft.Teams",
        "Microsoft.MicrosoftTeams",
        # Cortana (standalone app, Win10 2004+)
    ...
    Write-Step "Disabling Cortana on lock screen..."
    Set-ItemProperty -Path $cortanaPath -Name "AllowCortanaAboveLock" -Value 0 -Type DWord

    Write-Step "Disabling Cortana search box..."
    ...
    $tilePath = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"
    Set-ItemProperty -Path $tilePath -Name "SubscribedContent-314559Enabled" -Value 0 -Type DWord
    Set-ItemProperty -Path $tilePath -Name "SubscribedContent-314563Enabled" -Value 0 -Type DWord
